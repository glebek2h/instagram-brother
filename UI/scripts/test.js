...
function viewMvcTest() {
  ...
  photoPosts.addPhotoPost(new PhotoPost('11', '11  refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2000-02-23T23:00:00'), 'nastya', 'images/12.jpg', ['#bsu'], ['lol', 'kek']));
  ...
  photoPosts.addPhotoPost(new PhotoPost('14', '14 refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2018-00-23T23:00:00'), 'kop', 'images/15.jpg', ['#famcs', '#bsu'], ['lol', 'kek']));
  photoPosts.addPhotoPost(new PhotoPost('15', '15 refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2012-01-23T23:13:00'), 'dima', 'images/16.jpg', ['#famcs', '#bsu'], ['lol', 'kek']));
  photoPosts.addPhotoPost(new PhotoPost('16', '16 refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2007-02-23T23:11:00'), 'sasha', 'images/17.jpg', ['#famcs', '#bsu'], ['lol', 'kek']));
  photoPosts.addPhotoPost(new PhotoPost('17', '17 refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2018-03-23T23:22:00'), 'gleb', 'images/18.jpg', ['#famcs', ' #bsu'], ['lol', 'kek']));
  ...
  photoPosts.addPhotoPost(new PhotoPost('11', '19 refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2011-02-23T23:00:00'), 'gleb9990', 'images/20.jpg', ['#famcs'], ['kek']));
  photoPosts.addPhotoPost(new PhotoPost('20', '20  refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2000-02-23T23:00:00'), 'nastya', 'images/21.jpg', ['#bsu'], ['lol', 'kek']));
  photoPosts.addPhotoPost(new PhotoPost('21', '21  refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2019-02-23T23:00:00'), 'glebek2h', 'images/22.jpg', ['#famcs', '#bsu'], ['lol', 'kek']));
  ...
  photoPosts.addPhotoPost(new PhotoPost('23', '23 refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2018-00-23T23:00:00'), 'kop', 'images/24.jpg', ['#famcs', '#bsu'], ['lol', 'kek']));
  photoPosts.addPhotoPost(new PhotoPost('24', '24 refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2012-01-23T23:13:00'), 'dima', 'images/25.jpg', ['#famcs', '#bsu'], ['lol', 'kek']));
  photoPosts.addPhotoPost(new PhotoPost('25', '25 refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2007-02-23T23:11:00'), 'sasha', 'images/26.jpeg', ['#famcs', '#bsu'], ['lol', 'kek']));
  photoPosts.addPhotoPost(new PhotoPost('26', '26 refers to an image of the character HACKERMAN from the 2015 film Kung Fury that is used in jokes regarding a persons inflated sense of self-esteem when they solve a simple technical issue. ', new Date('2018-03-23T23:22:00'), 'gleb', 'images/27.jpg', ['#famcs', ' #bsu'], ['lol', 'kek']));
